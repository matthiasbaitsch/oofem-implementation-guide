...
```{.csharp include="oofem-csharp/oofem/Program.cs" start-line=33 end-line=37}
```
...
```{.csharp include="oofem-csharp/oofem/Program.cs" start-line=40 end-line=40}
```
...
```{.csharp include="oofem-csharp/oofem/Program.cs" start-line=42 end-line=42}
```
...
```{.csharp include="oofem-csharp/oofem-visualizer/Program.cs" start-line=24 end-line=28}
```
