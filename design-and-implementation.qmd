...
```{.python include="oofem-python/oofem/main.py" start-line=4 end-line=28}
```
...
```{.python include="oofem-python/oofem/main.py" start-line=33 end-line=42}
```
:::
...
```{.python include="oofem-python/oofem/main.py" start-line=45 end-line=51}
```
:::
...
```{.python include="oofem-python/oofem/main.py" start-line=53 end-line=54}
```
:::
...
```{.python include="oofem-python/oofem/main.py" start-line=56 end-line=56}
```
:::
...
```{.python include="oofem-python/oofem-visualizer/main.py" start-line=146 end-line=147}
```
:::
...
```{.python include="oofem-python/oofem-visualizer/main.py" start-line=153 end-line=153}
```
:::
