...
### Element stiffness matrix implementation
...
$$
\mathbf{d}^e = \frac{1}{l} (\mathbf{X}^2 - \mathbf{X}^1)
$$ 
...
```{.csharp}
 {{< include oofem-csharp/oofem-02/Program.cs >}}
```
